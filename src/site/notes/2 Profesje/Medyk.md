---
{"dg-publish":true,"permalink":"/2-profesje/medyk/","dgPassFrontmatter":true,"dg-note-properties":{}}
---
...
- **Specjalista** – ten medyk wyspecjalizował się w jednej dziedzinie. Gracz musi wybrać specjalizację z poniższej listy. Do wybranej specjalizacji ma zawsze +10% do testów jej leczenia. Specjalizacje: **choroby**, **zatrucia**, **rany cięte i szarpane**, **ciała obce** (np. odłamki, pociski), **poparzenia** (w tym blastery i miecze świetlne).
