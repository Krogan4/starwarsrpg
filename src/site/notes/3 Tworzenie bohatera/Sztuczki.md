...
## Atak zespołowy
Gdy postać w grupie (co najmniej jeden towarzysz) atakuje osamotnionego przeciwnika, jest w stanie dostosować się do ruchów towarzyszy, dzięki czemu kara przeciwnika za walkę z wieloma przeciwnikami wzrośnie o 2 punkty.
...
## Czujny
Posiadacz tej Sztuczki zawsze dostaje jeden Sukces podczas testów wykrywania zasadzki.
...
## Immunitet
Postać nigdy nie zarazi się chorobą podczas przebywania z chorymi lub leczenia pacjentów

Wymagania: Leczenie chorób 4+, Budowa 12+


## Jedność z maszyną
Jeżeli postać poświęciła nieco czasu, by przyzwyczaić się do konkretnej broni okrętowej, stała się z nią jednością. Teraz działo jest przedłużeniem ciała tej postaci, przez co nie dotyczą jej żadne utrudnienia wynikające z Utraty Kontroli.
...
Wymagania: Wrażliwość na Moc 15+, Niezłomność 5+
...
Postać jest w stanie tak „opatrzyć” swojego pacjenta, że podopieczny jest skrępowany i nie może się ruszyć.
...
## Przerażający
Posiadacz tej sztuczki potrafi być tak przerażający, że wszystkie osoby przebywające w jej pobliżu muszą przejść test Odwaga -8 lub otrzymują utrudnienie -1 do wszystkich akcji.
...
## Ruchliwość
Posiadacz tej sztuczki jest wyjątkowo ruchliwy i w czasie walki porusza się w nieprzewidywalny sposób. Trafienie jej z dystansu zawsze wiąże się z dodatkową Karą -1.

Wymagania: Zręczność 15+, Akrobatyka 4+
...
## Szachista
Decyzję należy podjąć na początku tury, przed wykonaniem rzutu pierwszego rzutu w walce w zwarciu lub przed testem Inicjatywy. Atakujący znający tę sztuczkę oddaje Inicjatywę, a w zamian otrzymuje +3 do Zręczności w obronie. Efekt utrzymuje się, dopóki nie wykona pierwszego ataku po przejęciu Inicjatywy.
...
## Zapędzony w róg
Posiadacz tej Sztuczki jest w stanie decydować o kierunku przemieszczania się walki wręcz tak, jakby to on był Agresorem, mimo że jest Obrońcą.

Wymagania: Walka Wręcz 5+ lub Broń Ręczna 5+
