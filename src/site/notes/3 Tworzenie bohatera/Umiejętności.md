...
- **Broń lekka (Zr)** – dotyczy wszelkiego rodzaju broni zasięgowej krótkiej, takiej jak pistolety czy pistolety maszynowe. Poza blasterami, umiejętność ta odpowiada za strzelanie z tradycyjnej broni palnej lekkiej.
...
- **Broń ręczna (Zr)** – dotyczy wszelkiego rodzaju broni do walki w zwarciu, takich jak wibroostrza, tradycyjne miecze, topory i broń obuchowa.

- **Miecze świetlne (Zr)** – dotyczy walki wszelkiej maści mieczami świetlnymi - zarówno długimi jak i krótkimi. Ich specyfika sprawia, że walczy się nimi zupełnie inaczej niż zwyczajnym mieczem.

- **Broń ręczna egzotyczna (Zr) (Konkretna)** – dotyczy nietypowych broni do walki w zwarciu takich jak bicze, sieci, miecze o podwójnych ostrzach, kije gaffi itp. Umiejętność osobna dla każdego rodzaju oręża

- **Pilotaż (Zr)** – umiejętność prowadzenia okrętów kosmicznych, atmosferycznych oraz pojazdów naziemnych i ścigaczy.
...
- **Skradanie się (Zr)** – umiejętność bezszelestnego przemykania nie pozostając wykrytym lub wtapiania się w tłum. Osoba, która doskonali tę umiejętność może z powodzeniem oszukać zmysły czujnych strażników pozostając w cieniu, cicho stawiając kroki lub schować się między workami na śmieci.

- **Zwinne dłonie (Zr)** – precyzyjna manipulacja manualna, często połączona z odwracaniem uwagi. Umiejętność odpowiadająca za wykonywanie skomplikowanych czynności palcami tak szybko lub tak dyskretnie, że są one niezauważalne dla postronnych obserwatorów. Wlicza się w to kradzież kieszonkową, otwieranie tradycyjnych zamków, podmiana kart w Sabaccu, czy schowanie małego przedmiotu do rękawa na oczach gapiów.
...
- **Kondycja (Bd)** – miara ogólnej sprawności fizycznej, wytrzymałości tlenowej oraz koordynacji całego ciała w ruchu. Określa, jak dobrze postać radzi sobie z pokonywaniem trudnego terenu, długotrwałym wysiłkiem oraz kontrolą nad wierzchowcami.
...
- **Zastraszanie (Bd)** - sztuka łamania woli przeciwnika poprzez demonstrację brutalnej siły, fizyczną dominację lub groźbę natychmiastowego uszkodzenia ciała. W przeciwieństwie do subtelnych gier słownych, tutaj argumentem jest rozmiar bicepsa, warkot silnika łańcuchowego lub przyłożenie lufy blastera do czoła.
### Zmysły
...
- **Spostrzegawczość (Zm)** – określa jak wiele postać może dostrzec, wyczuć lub usłyszeć, zwłaszcza, gdy się na tym skupia. Pomocne przy wypatrywaniu ukrytego przeciwnika, przy nasłuchiwaniu strażników, a także przeszukiwaniu miejsca zbrodni. Dostarcza informacji o uzbrojeniu przeciwnika przy przelotnym spojrzeniu lub dostrzec ukrytą pułapkę. Często będzie się wiązać z różnymi bonusami/karami w zależności od użytego zmysłu.

- **Sztuka przetrwania (Zm)** – określa zdolności survivalowe postaci, do których należy m.in. umiejętność zdobycia pożywienia, wody, znajomość gatunków czy orientacja w terenie. Pomaga także przygotować pułapki.

- **Tropienie (Zm)** – określa skuteczność postaci w dostrzeganiu śladów pozostawionych przez inne istoty oraz zacieraniu swoich śladów.
 
- **Intuicja (Zm)** – umiejętność dostrzegania kryjących się w postaciach pobudek, i stłumionych emocji. Zdolność oceny charakteru, zachowania, skłonności i predyspozycji napotkanej osoby. Użyteczne, przy próbie przekonania kogoś do własnych racji lub ocenie jego prawdomówności.

### Charakter

- **Gadanina (Ch)** – umiejętność zachowania się w danym miejscu, nawiązania rozmowy z odpowiednimi ludźmi, wyciąganiu informacji poprzez plotkowanie lub zabawienie rozmówców poprzez ekspresje i dobry ton głosu.
...
- **Perswazja (Ch)** – umiejętność odzwierciedlająca zdolność przekonywania innych do swoich racji. Zwykle opiera się o logiczne argumenty.

- **Niezłomność (Ch)** – siła woli, upór w dążeniu do zamierzonego celu, odwaga. Kluczowa, gdy ktoś próbuje nakłonić postać do działania wbrew jej zasadom. Ma znaczenie przy określaniu Punktów Mocy

- **Oszustwo (Ch)** – umiejętność zachowania kamiennej twarzy w stresujących sytuacjach. Postać używa jej, gdy blefuje i podaje się za kogoś kim nie jest.

- **Dowodzenie (Ch)** – umiejętność inspirowania podopiecznych. Skuteczne przy zarządzaniu ludźmi i wydawaniu rozkazów. Dzięki tej umiejętności postać jest w stanie zapewnić dodatkowe morale i niezłomność swoim żołnierzom bądź pracownikom, a także zwiększyć swoją siłę perswazji wobec ich.


### Intelekt

- **Komputery (In)** – umiejętność obsługi systemów komputerowych, łamania haseł, poruszania się w cyfrowej przestrzeni i mieszaniu w oprogramowaniu droidów. Dzięki tej umiejętności można otworzyć niektóre elektroniczne zamki.

- **Medycyna (In)** – zdolność zapewnienia pierwszej pomocy, leczenia ran i chorób. Postać z wysoką Medycyną może skutecznie wykonywać chirurgiczne operacje.

- **Technika (In)** – zdolności mechaniczne i elektryczne, pozwalające na naprawę, budowę i modyfikację urządzeń oraz droidów.
...
- Wiedza (dowolna) - dotyczy znajomości konkretnej materii; może być to dziedzina nauki lub znajomość jakiejś branży. Przykładowe: Chemia, Fizyka, Inżynieria, Wojskowość, Biznes i Technologia, Arkana Mocy, Półświatek, Polityka, Trendy i Celebryci, konkretne rejony Galaktyki.